...
CREATE TABLE `menu_item_categories` (
    ...
    UNIQUE INDEX `menu_item_categories_name_key`(`name`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `menu_items` ADD CONSTRAINT `menu_items_categoryId_fkey` FOREIGN KEY (`categoryId`) REFERENCES `menu_item_categories`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
